            ...
            builder: (context,refundReq,_) {
              return Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
                child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  Padding(padding: const EdgeInsets.all(8.0),
                                    child: Stack(children: [
                                        ...
                                        Positioned(top:0,right:0,
                                          child: InkWell(onTap :() => refundProvider.removeImage(index),
                      ...
                      Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                        child: InkWell(onTap: () => Provider.of<OrderProvider>(context, listen: false).pickImage(false),
                  ...
                  refundReq.isLoading? const Center(child: CircularProgressIndicator(),) : Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                        child: CustomButton(
                            ...
                            if(reason.isEmpty) {
                              ...
                              refundReq.refundRequest(context, widget.orderDetailsId,
                                ...
                                if(value.statusCode==200){
                                  ...
                                  showCustomSnackBar(getTranslated('successfully_requested_for_refund', context), context, isError: false);
