...
import 'package:yml_ecommerce_test/features/loyaltyPoint/widget/how_to_use_dialog.dart';
...
class _LoyaltyPointConverterDialogueState extends State<LoyaltyPointConverterDialogue> {
  ...
  Widget build(BuildContext context) {
    double? exchangeRate = Provider.of<SplashProvider>(context,listen: false).configModel!.loyaltyPointExchangeRate;
