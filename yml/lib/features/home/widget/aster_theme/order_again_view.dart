                          ...
                          itemBuilder: (context, detailsIndex) {
                            return Padding(padding: const EdgeInsets.only(right: Dimensions.paddingSizeSmall),
                              child: InkWell(onTap: (){
                                ...
                                child: CustomImage(fit: BoxFit.cover, width: 45, height: 45, image: '${Provider.of<SplashProvider>(context,listen: false).configModel?.baseUrls?.productThumbnailUrl}/${orders.details?[detailsIndex].product?.thumbnail??''}'),),
                            );
                          },
                        ),
