          ...
          child: Container(margin: const EdgeInsets.symmetric(vertical : Dimensions.paddingSizeExtraSmall),
            ...
            child: Stack(children: [
              Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                ...
                Padding(padding: const EdgeInsets.all(6.0), child: Container(height: 200,
                    ...
                    child: ClipRRect(borderRadius: const BorderRadius.all( Radius.circular(10)),
                      child: CustomImage(image: '${splashController.baseUrls!.productThumbnailUrl}''/${product.thumbnail}')))),
                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
                      Padding(padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeExtraSmall),
                        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          Text(product.rating!.isNotEmpty ? double.parse(product.rating![0].average!).toStringAsFixed(1) : '0.0',
                      ...
                      Row( mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Text(PriceConverter.convertPrice(context, product.unitPrice, discountType: product.discountType,
