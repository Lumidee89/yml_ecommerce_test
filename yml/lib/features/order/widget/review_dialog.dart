...
import 'package:yml_ecommerce_test/features/order/domain/model/review_body.dart';
                          ...
                          onTap: () {
                            if(Provider.of<ProductDetailsProvider>(context, listen: false).rating == 0) {
                              ...
                              Provider.of<ProductDetailsProvider>(context, listen: false).submitReview(reviewBody,
                                  orderProvider.reviewImages, Provider.of<AuthController>(context, listen: false).getUserToken()).then((value) {
                                if(value.isSuccess) {
