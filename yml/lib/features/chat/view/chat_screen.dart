...
import 'package:yml_ecommerce_test/features/chat/widget/chat_shimmer.dart';
import 'package:yml_ecommerce_test/features/chat/widget/message_bubble.dart';
...
class ChatScreen extends StatefulWidget {
  ...
  final String? image;
  final String? phone;
  const ChatScreen({super.key,  this.id, required this.name,  this.isDelivery = false,  this.image, this.phone});
                ...
                child: SizedBox(height: 50,
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    InkWell(
                      ...
                      child: chatProvider.isMessageSend ? const Padding(padding: EdgeInsets.all(8.0),
