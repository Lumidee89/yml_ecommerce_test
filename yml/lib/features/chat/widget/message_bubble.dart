...
import 'package:yml_ecommerce_test/features/chat/domain/model/message_model.dart';
            ...
            mainAxisAlignment: isMe ? MainAxisAlignment.end : MainAxisAlignment.start, children: [
              isMe ? const SizedBox.shrink() : Container( width: 40, height: 40,
                ...
                child: ClipRRect(borderRadius: BorderRadius.circular(20.0),
                  child: CustomImage(fit: BoxFit.cover, width: 40, height: 40, image: '$baseUrl/$image'))),
