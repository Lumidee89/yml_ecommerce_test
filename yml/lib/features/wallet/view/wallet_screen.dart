...
import 'package:yml_ecommerce_test/basewidget/transaction_filter_bottom_sheet.dart';
import 'package:yml_ecommerce_test/features/home/view/aster_theme_home_page.dart';
import 'package:yml_ecommerce_test/features/home/shimmer/wallet_bonus_shimmer.dart';
import 'package:yml_ecommerce_test/features/wallet/widget/transaction_list_view.dart';
import 'package:yml_ecommerce_test/features/wallet/widget/wallet_card_widget.dart';
                      ...
                      builder: (context, walletP,_) {
                        return Padding(padding: const EdgeInsets.only(top: Dimensions.paddingSizeSmall),
                          child: Container(height: MediaQuery.of(context).size.width/3.0,
                            ...
                            decoration: BoxDecoration(color: Provider.of<ThemeProvider>(context, listen: false).darkTheme? Theme.of(context).cardColor : Theme.of(context).primaryColor,
                                        ...
                                        CrossAxisAlignment.start, children: [
                                          ...
                                          if(walletProvider.walletBonusModel!.bonusList![index].endDateTime != null)
                                            Padding(padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeExtraSmall),
                                              child: Text('${getTranslated('valid_till', context)} ${DateConverter.dateTimeStringToDateTime(walletProvider.walletBonusModel!.bonusList![index].endDateTime!)}', style: textRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),),
