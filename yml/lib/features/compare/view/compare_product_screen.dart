...
import 'package:yml_ecommerce_test/basewidget/remove_wish_list_bottom_sheet.dart';
import 'package:yml_ecommerce_test/features/compare/widget/custom_top_sheet.dart';
import 'package:yml_ecommerce_test/features/search/widget/partial_matched.dart';
                              ...
                              for (int i = 0; i < compareProvider.attributeList!.length; i++) {
                                ...
                                for (int j = 0; j < product!.choiceOptions!.length; j++) {
                                  if (compareProvider.attributeList![i].name == product!.choiceOptions![j].title) {
                                    variation.add(product!.choiceOptions![j].options!);
                                    foundMatch = true;
                                ...
                                if (!foundMatch) {
                                  variation.add(['No ${compareProvider.attributeList![i].name}']);
                                }
                              }
