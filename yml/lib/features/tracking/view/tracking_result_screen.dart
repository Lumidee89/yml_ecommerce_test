...
import 'package:yml_ecommerce_test/features/tracking/widget/line_dashed_painter.dart';
          ...
          Expanded(child: Consumer<OrderProvider>(
              builder: (context, tracking, child) {
                ...
                ListView( children: [
                  ...
                  CustomStepper(icon: Images.shipment, title: '${getTranslated('preparing_for_shipment', context)}',
                    checked: (status == statusList[2] || status == statusList[3] ||status == statusList[4])),


                  CustomStepper(icon: Images.outForDeliveryIcon, title: '${getTranslated('order_is_on_the_way', context)}',
